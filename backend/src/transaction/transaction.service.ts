...
export class TransactionService {
  ...
  async createTransaction(data: any) {
    // 1. Resolve or create CustomerProfile
    ...
    // 3. Resolve Product & Currency IDs
    ...
    // Create Order and tasks inside a transaction
  ...
  async updateStatus(id: string, status: OrderStatus, changedById: string) {
    // Record Order transition audit log
