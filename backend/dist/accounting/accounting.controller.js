...
__decorate(
  [
    ...
    (0, swagger_1.ApiOperation)({
      summary: 'Create a new General Ledger account (Staff Only)',
    }),
...
__decorate(
  [
    ...
    (0, swagger_1.ApiOperation)({
      summary: 'List all General Ledgers (Staff Only)',
    }),
...
__decorate(
  [
    ...
    (0, swagger_1.ApiOperation)({
      summary: 'Create a Journal Entry (Staff Only)',
    }),
    (0, swagger_1.ApiResponse)({
      status: 201,
...
__decorate(
  [
    ...
    (0, swagger_1.ApiOperation)({
      summary: 'List all Journal Entries (Staff Only)',
    }),
    (0, swagger_1.ApiResponse)({
      status: 200,
