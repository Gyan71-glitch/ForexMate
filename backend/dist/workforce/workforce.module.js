...
const workforce_jwt_strategy_1 = require("./guards/workforce-jwt.strategy");
...
exports.WorkforceModule = WorkforceModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [workforce_service_1.WorkforceService, workforce_jwt_strategy_1.WorkforceJwtStrategy],
    })
], WorkforceModule);
