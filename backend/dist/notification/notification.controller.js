...
let NotificationController = class NotificationController {
    ...
    async readNotification(id, req) {
        return this.notificationService.markAsRead(id, req.user.id);
    }
    async readAllNotifications(req) {
...
__decorate([
    (0, common_1.Get)(),
    (0, swagger_1.ApiOperation)({ summary: 'Get unread/recent in-app notifications for the logged-in user' }),
...
__decorate([
    ...
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], NotificationController.prototype, "readAllNotifications", null);
exports.NotificationController = NotificationController = __decorate([
    (0, swagger_1.ApiTags)('In-App Notifications'),
